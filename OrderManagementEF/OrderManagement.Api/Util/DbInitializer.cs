...
public class DbInitializer(IServiceScopeFactory scopeFactory, IConfiguration configuration) : BackgroundService
{
  protected override async Task ExecuteAsync(CancellationToken stoppingToken = default)
  {
		...
		var db = scope.ServiceProvider.GetRequiredService<OrderManagement.Dal.OrderManagementContext>();
	...
	*/
        ...
        await Task.CompletedTask; // TODO remove this statement

    }

    /* TODO enable
	private static async Task InitDatabase(OrderManagement.Dal.OrderManagementContext db, CancellationToken stoppingToken)
	{
